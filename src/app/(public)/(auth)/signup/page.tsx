          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              {validations.phoneNumber.isFull && !validations.phoneNumber.isValid && (
                <div className="mt-2">
                  <p className="text-sm text-red-600 dark:text-red-400">Número de telefone inválido</p>
                </div>
              )}
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <label
                ...
                className="text-xs text-gray-600 dark:text-gray-400 py-2"
              >
                Concordo em receber mensagens no WhatsApp e e-mails sobre os eventos da DSUSP de acordo com a{' '}
                <Link 
