...
import { Prisma, OrderStatus } from '@prisma/client'; // Import Prisma for error types and OrderStatus enum
    ...
    if (body.action === 'payment.created' || body.action === 'payment.updated') {
      ...
      await prisma.$transaction(async (tx) => {
        ...
        await tx.payment.update({
          ...
          data: {
            status: mpPaymentStatus, // String do status do pagamento
            paidAt:
        ...
        if (newOrderStatus) {
          await tx.orderStatusHistory.create({
            data: {
              ...
              newStatus: newOrderStatus as OrderStatus, // Usando o enum OrderStatus
              notes: historyNotes,
            },
          });
        }
