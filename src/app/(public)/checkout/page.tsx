...
import { CardPaymentData, PixPaymentData } from '@/components/payment/types';
...
export default function CheckoutPage(): React.ReactNode {
  ...
  async function handleCardPaymentCreate(paymentData: CardPaymentData) {
    // Aqui você pode integrar com o backend ou exibir feedback
    console.log('Pagamento cartão:', paymentData);
  }
  
  async function handlePixPaymentCreate(paymentData: PixPaymentData) {
    // Aqui você pode integrar com o backend ou exibir feedback
